...
[assembly: MelonInfo(typeof(ChallengeRarity.Main), "ChallengeOnlyRare", "1.0.0", "Fur")]
...
public class ChallengeOnlyRare : MelonMod
{
    ...
    class LuckPatch
    {
        ...
        {
            itemRarities = new List<Item2.Rarity> { Item2.Rarity.Rare };
